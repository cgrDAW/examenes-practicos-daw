...
Cabeceras de Respuesta. 20p
---------------------------

#. Crea la página p1.php que devuelva la cadena "Hola" pero que añada en la cabecera de respuetas el tipo MIME adecuado (text/plain)
...
#. Si no ha seleccionado ningún color, le mostramos un formulario para que lo seleccione
#. Si tiene alguno seleccionado, le mostramos un texto en su color preferido
#. Se mostrará un botón para borrar la selección

Para reiniciar la aplicación, es decir al pulsar el botón de borrar la selección, puedes hacerlo de diferentes formas (llamando al a misma página quizá es lo más sencillo).
